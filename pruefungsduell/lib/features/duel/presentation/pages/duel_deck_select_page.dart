...
class DuelDeckSelectPage extends StatefulWidget {
  ...
  @override
  State<DuelDeckSelectPage> createState() => _DuelDeckSelectPageState();
}

class _DuelDeckSelectPageState extends State<DuelDeckSelectPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Prüfungsduell')),
