...
import 'package:pruefungsduell/features/duel/presentation/pages/duel_deck_select_page.dart';
          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('Prüfungsduell'),
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => const DuelDeckSelectPage(),
                    ),
                  );
                },
              ),
